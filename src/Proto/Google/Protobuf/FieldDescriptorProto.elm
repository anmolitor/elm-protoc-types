...
module Proto.Google.Protobuf.FieldDescriptorProto exposing
    ( Label(..), Type(..), decodeLabel, decodeType, defaultLabel, defaultType, encodeLabel, encodeType, fieldNumbersLabel, fieldNumbersType
    , fromInternalLabel, fromInternalType, jsonEncodeLabel, jsonEncodeType, toInternalLabel, toInternalType
    )
...
@docs fromInternalLabel, fromInternalType, jsonEncodeLabel, jsonEncodeType, toInternalLabel, toInternalType
...
jsonEncodeLabel =
    toInternalLabel >> Proto.Google.Protobuf.Internals_.jsonEncodeProto__Google__Protobuf__FieldDescriptorProto__Label
...
jsonEncodeType =
    toInternalType >> Proto.Google.Protobuf.Internals_.jsonEncodeProto__Google__Protobuf__FieldDescriptorProto__Type
