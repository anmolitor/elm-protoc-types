...
module Proto.Google.Protobuf.GeneratedCodeInfo exposing (Annotation, decodeAnnotation, defaultAnnotation, encodeAnnotation, fieldNumbersAnnotation, jsonEncodeAnnotation)
...
@docs Annotation, decodeAnnotation, defaultAnnotation, encodeAnnotation, fieldNumbersAnnotation, jsonEncodeAnnotation
...
-}
fieldNumbersAnnotation : { path : Int, sourceFile : Int, begin : Int, end : Int, semantic : Int }
