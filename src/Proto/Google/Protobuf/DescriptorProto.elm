...
module Proto.Google.Protobuf.DescriptorProto exposing
    ...
    , encodeExtensionRange, encodeReservedRange, fieldNumbersExtensionRange, fieldNumbersReservedRange, jsonDecodeExtensionRange
    , jsonDecodeReservedRange, jsonEncodeExtensionRange, jsonEncodeReservedRange
    )
