...
module Proto.Google.Protobuf.Field.Cardinality exposing
    ( Cardinality(..), decodeCardinality, defaultCardinality, encodeCardinality, fieldNumbersCardinality, jsonDecodeCardinality
