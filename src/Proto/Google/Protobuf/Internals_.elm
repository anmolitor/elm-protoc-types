...
decodeProto__Google__Protobuf__Value__Kind__Kind =
    Protobuf.Decode.oneOf
        ...
        , ( 5
          , Protobuf.Decode.map Proto__Google__Protobuf__Value__Kind__StructValue decodeProto__Google__Protobuf__Struct
          )
        , ( 6
          , Protobuf.Decode.map Proto__Google__Protobuf__Value__Kind__ListValue decodeProto__Google__Protobuf__ListValue
          )
        ]
...
{-| Default for Proto__Google__Protobuf__Field__Cardinality. Should only be used for 'required' decoders as an initial value.
...
-}
encodeProto__Google__Protobuf__Field__Cardinality :
    Proto__Google__Protobuf__Field__Cardinality -> Protobuf.Encode.Encoder
...
{-| Default for Proto__Google__Protobuf__Field__Kind. Should only be used for 'required' decoders as an initial value.
...
{-| Default for Proto__Google__Protobuf__NullValue. Should only be used for 'required' decoders as an initial value.
...
{-| Default for Proto__Google__Protobuf__Syntax. Should only be used for 'required' decoders as an initial value.
