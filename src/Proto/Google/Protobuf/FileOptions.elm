...
module Proto.Google.Protobuf.FileOptions exposing
    ...
    , jsonEncodeOptimizeMode, toInternalOptimizeMode
    )
...
@docs jsonEncodeOptimizeMode, toInternalOptimizeMode
...
jsonEncodeOptimizeMode =
    toInternalOptimizeMode
        >> Proto.Google.Protobuf.Internals_.jsonEncodeProto__Google__Protobuf__FileOptions__OptimizeMode
