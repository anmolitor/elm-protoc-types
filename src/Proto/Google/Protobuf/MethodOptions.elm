...
module Proto.Google.Protobuf.MethodOptions exposing
    ( IdempotencyLevel(..), decodeIdempotencyLevel, defaultIdempotencyLevel, encodeIdempotencyLevel, fieldNumbersIdempotencyLevel
    , fromInternalIdempotencyLevel, jsonEncodeIdempotencyLevel, toInternalIdempotencyLevel
    )
...
@docs fromInternalIdempotencyLevel, jsonEncodeIdempotencyLevel, toInternalIdempotencyLevel
...
jsonEncodeIdempotencyLevel =
    toInternalIdempotencyLevel
        >> Proto.Google.Protobuf.Internals_.jsonEncodeProto__Google__Protobuf__MethodOptions__IdempotencyLevel
...
-}
toInternalIdempotencyLevel : IdempotencyLevel -> Proto.Google.Protobuf.Internals_.Proto__Google__Protobuf__MethodOptions__IdempotencyLevel
...
-}
fromInternalIdempotencyLevel : Proto.Google.Protobuf.Internals_.Proto__Google__Protobuf__MethodOptions__IdempotencyLevel -> IdempotencyLevel
