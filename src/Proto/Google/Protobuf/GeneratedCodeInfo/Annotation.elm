...
module Proto.Google.Protobuf.GeneratedCodeInfo.Annotation exposing
    ( Semantic(..), decodeSemantic, defaultSemantic, encodeSemantic, fieldNumbersSemantic, fromInternalSemantic, jsonEncodeSemantic
    , toInternalSemantic
    )
...
@docs Semantic, decodeSemantic, defaultSemantic, encodeSemantic, fieldNumbersSemantic, fromInternalSemantic, jsonEncodeSemantic
@docs toInternalSemantic
...
jsonEncodeSemantic =
    toInternalSemantic
        >> Proto.Google.Protobuf.Internals_.jsonEncodeProto__Google__Protobuf__GeneratedCodeInfo__Annotation__Semantic
