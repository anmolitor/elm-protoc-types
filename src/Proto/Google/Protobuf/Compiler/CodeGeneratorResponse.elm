...
module Proto.Google.Protobuf.Compiler.CodeGeneratorResponse exposing
    ( Feature(..), File, decodeFeature, decodeFile, defaultFeature, defaultFile, encodeFeature, encodeFile, fieldNumbersFeature, fieldNumbersFile
    , fromInternalFeature, jsonEncodeFeature, jsonEncodeFile, toInternalFeature
    )
...
@docs fromInternalFeature, jsonEncodeFeature, jsonEncodeFile, toInternalFeature
...
jsonEncodeFeature =
    toInternalFeature
        >> Proto.Google.Protobuf.Compiler.Internals_.jsonEncodeProto__Google__Protobuf__Compiler__CodeGeneratorResponse__Feature
