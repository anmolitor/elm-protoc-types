...
module Proto.Google.Protobuf.Compiler.Internals_ exposing
    ...
    , fieldNumbersProto__Google__Protobuf__Compiler__Version, jsonEncodeProto__Google__Protobuf__Compiler__CodeGeneratorRequest
    , jsonEncodeProto__Google__Protobuf__Compiler__CodeGeneratorResponse
    , jsonEncodeProto__Google__Protobuf__Compiler__CodeGeneratorResponse__Feature
...
@docs fieldNumbersProto__Google__Protobuf__Compiler__Version, jsonEncodeProto__Google__Protobuf__Compiler__CodeGeneratorRequest
@docs jsonEncodeProto__Google__Protobuf__Compiler__CodeGeneratorResponse
@docs jsonEncodeProto__Google__Protobuf__Compiler__CodeGeneratorResponse__Feature
...
jsonEncodeProto__Google__Protobuf__Compiler__CodeGeneratorResponse value =
    Json.Encode.object <|
        List.concat
            ...
            , [ ( "supportedFeatures"
                , (Protobuf.Utils.Int64.toSignedString >> Json.Encode.string) value.supportedFeatures
                )
              ]
            , [ ( "file"
...
{-| Encode a `Proto__Google__Protobuf__Compiler__CodeGeneratorResponse__Feature` to JSON. Uses the canonical encoding described here: <https://protobuf.dev/programming-guides/proto3/#json>
-}
jsonEncodeProto__Google__Protobuf__Compiler__CodeGeneratorResponse__Feature : Proto__Google__Protobuf__Compiler__CodeGeneratorResponse__Feature -> Json.Encode.Value
jsonEncodeProto__Google__Protobuf__Compiler__CodeGeneratorResponse__Feature value =
    Json.Encode.string <|
        case value of
...
{-| Default for Proto\_\_Google**Protobuf**Compiler**CodeGeneratorResponse**Feature. Should only be used for 'required' decoders as an initial value.
-}
defaultProto__Google__Protobuf__Compiler__CodeGeneratorResponse__Feature : Proto__Google__Protobuf__Compiler__CodeGeneratorResponse__Feature
defaultProto__Google__Protobuf__Compiler__CodeGeneratorResponse__Feature =
    Proto__Google__Protobuf__Compiler__CodeGeneratorResponse__FEATURENONE
...
-}
encodeProto__Google__Protobuf__Compiler__CodeGeneratorResponse__Feature : Proto__Google__Protobuf__Compiler__CodeGeneratorResponse__Feature -> Protobuf.Encode.Encoder
...
-}
decodeProto__Google__Protobuf__Compiler__CodeGeneratorResponse__Feature : Protobuf.Decode.Decoder Proto__Google__Protobuf__Compiler__CodeGeneratorResponse__Feature
decodeProto__Google__Protobuf__Compiler__CodeGeneratorResponse__Feature =
